...
class AccountsWidget {
  ...
  registerEvents() {
    this.element.addEventListener('click', (el) => {
      ...
      } else if (el.target.closest('li').classList.contains('account')) {
        this.onSelectAccount(el.target.closest('li'))
      }
    })
  }
  ...
  getAccountHTML(item){
    ...
    li.insertAdjacentHTML('afterbegin', `<a href='#'><span>${item.name}</span> / <span>${item.sum} ₽</span></a>`);
    return li;
  }
